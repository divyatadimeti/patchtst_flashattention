...
def patch_sizes_experiment(model_config, train_config, log_config, data_config):
...
def batch_sizes_experiment(model_config, train_config, log_config, data_config):
...
def dataset_experiment(model_config, train_config, log_config, data_config):
...
def num_workers_experiment(model_config, train_config, log_config, data_config):
...
def driver(model_config, train_config, log_config, data_config):
